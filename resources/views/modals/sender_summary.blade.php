<div class="modal fade" id="senderSummary{{ $address->id }}" tabindex="-1" aria-labelledby="senderSummary{{ $address->id }}Label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="senderSummary{{ $address->id }}Label">Sender summary</h5>
                                ...
                                <tr>
                                    <td colspan="4">
                                        <form action="{{ route('shipments.search') }}" method="post">
                                            ...
                                            <input type="hidden" name="sender" value="{{ $address->id }}">
